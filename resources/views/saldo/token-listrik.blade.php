                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                               ...
                               <form role="form" method="post" action="{{ route('storeElectricBill') }}">
                                @csrf
                                <div class="card-header pb-0 text-start">
                                    <h4 class="font-weight-bolder">
                                        <a href="/kirim"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;Isi Token Listrik
                                    </h4>
                                    <p class="mb-0"></p>
                                </div>
                                ...
                                <div class="card-body py-0">
                                    <div class="text-center">
                                        <div class="text-start w-100 mt-4 mb-0 py-0 pb-1">&nbsp;Meter ID/Customer ID</div>
                                        <div class="mb-3">
                                            <input type="text" name="meter_number" class="form-control form-control-lg" placeholder=" 5356-7890-10xx." aria-label="meter_number">
                                            @error('meter_number') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                        </div>
