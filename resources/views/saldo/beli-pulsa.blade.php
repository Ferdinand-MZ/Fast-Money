                    ...
                    <div class="container-fluid">
                        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="{{ route('home') }}">
                            ...
                            <ul class="navbar-nav d-lg-block d-none">
                                <li class="nav-item">
                                    <a href="/isi" class="btn btn-sm mb-0 me-1 btn-primary">isi Saldo</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto">
                            <div class="card card-plain">
                               ...
                               <form role="form" method="post" action="{{ route('storeCreditBill') }}">
                                @csrf
                                <div class="card-header pb-0 text-start">
                                    <h4 class="font-weight-bolder">
                                        <a href="/kirim"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>&nbsp;&nbsp;&nbsp;Beli Pulsa
                                    </h4>
                                    <p class="mb-0"></p>
                                </div>
                                ...
                                <div class="card-body py-0">
                                    <div class="text-center">
                                        <div class="text-start w-100 mt-4 mb-0 py-0 pb-1">&nbsp;Nomer Telepon</div>
                                        <div class="mb-3">
                                            <input type="text" name="no_telp" class="form-control form-control-lg" placeholder="08962346xxxx" aria-label="no_telp">
                                            @error('no_telp') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                        </div>

                                        <div class="text-center">
                                            <div class="text-start w-100 mt-4 mb-0 py-0 pb-1">&nbsp;Daftar Provider</div>
                                            <div class="mb-3">
                                                <select class="form-control form-control-lg" aria-label="Daftar Provider" name="provider">
                                            ...
                                            @error('provider') <p class='text-danger text-xs pt-1'> {{ $message }} </p> @enderror
                                        </div>
